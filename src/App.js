...
class  App extends Components {
  ...
  render() {
    ...
    const newHistoryList = latestHistoryList.filter(eachValue =>
      eachValue.toLowercase().includes(searchInput.toLowercase()),
      )
      if (newHistorylist.length == 0) {
        isTrue = true  
      }
      return (
        <div calssName = "main-container">
        ...
        <div className = "content-holder">
          ...
          {newHistoryList.map(eachObject => (
             ...
             >
              ...
              <div className = "logo-content">
                <p className = "name">{eachObject.titile}</p>
         ...
         {isTrue && (
          <div className="empty-container">
            <p className = "empty-element"> There is no histor to show</p>
          </div>
         )}
